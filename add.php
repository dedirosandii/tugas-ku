...
<body>
    <!-- <div class="card-box" style="height: 50% ;" id="map"></div> -->


    <div class="block py-5">
        <!-- d-md-none d-lg-none d-xl-none -->
        <div class="xs-pd-20-10 pd-ltr-20">
            <form action="process-add.php" enctype="multipart/form-data" method="post">
                <div class="row">

                    <div class="col-sm-12 card-box px-5 py-5">
                        <div class="form-group">
                            <input type="text" name="name_location" class="form-control" required placeholder="Name Location" required>
                        </div>
                        ...
                        <div class="form-group mt-2">
                            <input type="text" name="distance" id="txt-result-area" class="form-control" required placeholder="Measurement results">
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <input type="text" id="lat" name="latitude" class="form-control" readonly required placeholder="Get latitude automatically">
                            </div>
                            <div class="col-6">
                                <input type="text" id="lng" name="longitude" class="form-control" readonly required placeholder="Get longitude automatically">
                            </div>
                        </div>


                        <button type="submit" class="btn btn-block btn-sm btn-warning mb-30 mt-3"> Submit</button>
                    </div>
                </div>
            </form>
        </div>
