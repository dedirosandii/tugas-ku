!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).MeasureTool =
        e());
})(this, function () {
  "use strict";
  function t(t, e) {
  ...
  p.prototype = h.prototype = {
    ...
    on: function (t, e) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++r < a; )
          if ((n = (t = o[r]).type)) i[n] = _(i[n], t.name, e);
          else if (null == e) for (n in i) i[n] = _(i[n], t.name, null);
        return this;
      }
      for (; ++r < a; )
        if ((n = (t = o[r]).type) && (n = g(i[n], t.name))) return n;
    },
    copy: function () {
      var t = {},
        e = this._;
  ...
  function y(t) {
    ...
    return (
      ...
      v.hasOwnProperty(e) ? { space: v[e], local: t } : t
    );
  }
  function m(t) {
    return function () {
      var e = this.ownerDocument,
        n = this.namespaceURI;
      return n === d && e.documentElement.namespaceURI === d
        ? e.createElement(t)
  ...
  function D(t, e, n, i, o, r) {
    for (var a, s = 0, l = e.length, c = r.length; s < c; ++s)
      (a = e[s]) ? ((a.__data__ = r[s]), (i[s] = a)) : (n[s] = new M(t, r[s]));
  ...
  function U(t, e, n, i, o, r, a) {
    ...
    for (s = 0; s < h; ++s)
      (l = e[s]) &&
        ((f[s] = c = a.call(l, l.__data__, s, e) + ""),
        u.has(c) ? (o[s] = l) : u.set(c, l));
    for (s = 0; s < p; ++s)
      (c = a.call(t, r[s], s, r) + ""),
        (l = u.get(c))
          ? ((i[s] = l), (l.__data__ = r[s]), u.delete(c))
          : (n[s] = new M(t, r[s]));
  ...
  function Z(t, e) {
    return (
      ...
      Y(t).getComputedStyle(t, null).getPropertyValue(e)
    );
  }
  function J(t) {
    return function () {
    ...
    return function () {
      ...
      if (o)
        for (var a = 0, s = o.length; a < s; ++a)
          if ((i = o[a]).type === t.type && i.name === t.name)
            return (
  ...
  kt.prototype = {
    ...
    select: function (t) {
      ...
      for (
        ...
        for (
          var r, a, s = e[o], l = s.length, c = (i[o] = new Array(l)), u = 0;
          u < l;
          ++u
        )
          (r = s[u]) &&
            (a = t.call(r, r.__data__, u, s)) &&
            ("__data__" in r && (a.__data__ = r.__data__), (c[u] = a));
    ...
    selectAll: function (t) {
      ...
      for (
        ...
        for (var a, s = e[r], l = s.length, c = 0; c < l; ++c)
    ...
    filter: function (t) {
      ...
      for (
        ...
        for (var r, a = e[o], s = a.length, l = (i[o] = []), c = 0; c < s; ++c)
          (r = a[c]) && t.call(r, r.__data__, c, a) && l.push(r);
      return new kt(i, this._parents);
    },
    data: function (t, e) {
      ...
      for (
        ...
        var u = i[c],
          ...
          v = (l[c] = new Array(p));
        n(u, h, _, d, v, f, e);
        for (var y, m, x = 0, b = 0; x < g; ++x)
          if ((y = _[x])) {
            for (x >= b && (b = x + 1); !(m = d[b]) && ++b < g; );
            y._next = m || null;
          }
      }
    ...
    sort: function (t) {
      ...
      for (
        ...
        for (
          var a, s = n[r], l = s.length, c = (o[r] = new Array(l)), u = 0;
          u < l;
          ++u
        )
          (a = s[u]) && (c[u] = a);
    ...
    each: function (t) {
      for (var e = this._groups, n = 0, i = e.length; n < i; ++n)
        for (var o, r = e[n], a = 0, s = r.length; a < s; ++a)
    ...
    style: function (t, e, n) {
      return arguments.length > 1
        ? this.each(
            (null == e ? X : "function" == typeof e ? G : F)(
              t,
              e,
              null == n ? "" : n
            )
    ...
    property: function (t, e) {
      return arguments.length > 1
        ? this.each((null == e ? J : "function" == typeof e ? W : K)(t, e))
        : this.node()[t];
    },
    ...
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? at : ("function" == typeof t ? lt : st)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? ct : ("function" == typeof t ? ht : ut)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(pt);
    ...
    insert: function (t, e) {
      var n = "function" == typeof t ? t : b(t),
        i = null == e ? gt : "function" == typeof e ? e : T(e);
      return this.select(function () {
    ...
    on: function (t, e, n) {
      var i,
        ...
        a = r.length;
      if (!(arguments.length < 2)) {
        for (s = e ? xt : mt, i = 0; i < a; ++i) this.each(s(r[i], e, n));
        return this;
      }
    ...
    [Symbol.iterator]: function* () {
      for (var t = this._groups, e = 0, n = t.length; e < n; ++e)
        for (var i, o = t[e], r = 0, a = o.length; r < a; ++r)
          (i = o[r]) && (yield i);
    },
  };
  var jt = (t) => () => t;
  ...
  function Nt() {
    ...
    function g(a, s) {
      if (!i && o.call(this, a, s)) {
        ...
        l &&
          (Ct(a.view).on("mousemove.drag", _, !0).on("mouseup.drag", d, !0),
          (function (t) {
            var e = t.document.documentElement,
              n = Ct(t).on("dragstart.drag", St, !0);
            "onselectstart" in e
    ...
    function d(t) {
      Ct(t.view).on("mousemove.drag mouseup.drag", null),
        (function (t, e) {
          var n = t.document.documentElement,
            i = Ct(t).on("dragstart.drag", null);
          e &&
    ...
    function v(t, e) {
      if (o.call(this, t, e)) {
        var n,
          ...
          l = a.length;
        for (n = 0; n < l; ++n)
          (i = x(this, s, t, e, a[n].identifier, a[n])) &&
            (At(t), i("start", t, a[n]));
      }
    }
    function y(t) {
      var e,
        ...
        o = i.length;
      for (e = 0; e < o; ++e)
        (n = l[i[e].identifier]) && (St(t), n("drag", t, i[e]));
    }
    function m(t) {
      var e,
        n,
      ...
      for (
        ...
        (n = l[o[e].identifier]) && (At(t), n("end", t, o[e]));
    }
    ...
    return (
      (f.filter = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : jt(!!t)), f)
          : o;
      }),
      (f.container = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : jt(t)), f)
          : r;
      }),
      (f.subject = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? t : jt(t)), f)
          : a;
      }),
      (f.touchable = function (t) {
        return arguments.length
          ? ((s = "function" == typeof t ? t : jt(!!t)), f)
          : s;
      }),
      (f.on = function () {
  ...
  var It = {
    ...
    Bt = "en",
    Rt = function (t, e) {
      if (It[t]) return It[t][e];
      var n = t.split("-")[0];
      return It[n] ? It[n][e] : It.en[e];
    },
    zt = "measure-tool",
    qt = function () {
      var t =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Bt;
      return Rt(t, "tooltipText1");
    },
    Ht = function () {
      var t =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Bt;
      return Rt(t, "tooltipText2");
    },
    Vt = [],
    Yt = [];
  function Xt(t, e) {
    if (t && "undefined" != typeof document) {
      ...
      if (o) {
        var a = Vt.indexOf(r);
        -1 === a && ((a = Vt.push(r) - 1), (Yt[a] = {})),
          (n = Yt[a] && Yt[a][i] ? Yt[a][i] : (Yt[a][i] = s()));
      } else n = s();
    ...
    function s() {
      ...
      if ((t.setAttribute("type", "text/css"), e.attributes))
        for (var n = Object.keys(e.attributes), o = 0; o < n.length; o++)
          t.setAttribute(n[o], e.attributes[n[o]]);
  ...
  var Gt = (function () {
      function t(e, i) {
        n(this, t),
          ...
          (this._options = Object.assign({}, this._defaultOptions, i || {})),
          (this._parentDiv = e),
          (this._containerDiv = document.createElement("div")),
          this._containerDiv.classList.add("".concat(zt, "-context-menu")),
          (this._containerDiv.stylesheet = Ft),
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var e =
                  this._parentDiv.getBoundingClientRect().width <=
                  t.x + this.width,
                n =
                  this._parentDiv.getBoundingClientRect().height <=
                  t.y + this.height;
              this._containerDiv.style.cssText += "\n      "
  ...
  var Jt = (function () {
      function t(e) {
        n(this, t),
          (this._parentDiv = e),
          (this._containerDiv = document.createElement("div")),
          this._containerDiv.classList.add("".concat(zt, "-tooltip")),
          (this._containerDiv.stylesheet = Zt),
          e.appendChild(this._containerDiv);
      }
      return (
        o(t, [
          {
            ...
            value: function (t, e) {
              ...
              (this._containerDiv.style.cssText +=
                t.x < n / 2
                  ? "left: ".concat(t.x, "px;")
                  : "right: ".concat(n - t.x, "px;")),
                (this._containerDiv.style.cssText +=
                  t.y < i / 2
                    ? "top: ".concat(t.y, "px")
                    : "bottom: ".concat(i - t.y, "px;")),
          ...
          },
          {
            ...
            get: function () {
              ...
              if (this._nodes.length > 1)
                for (var e = 1; e < this._nodes.length; e++)
                  t.push([this._nodes[e - 1], this._nodes[e]]);
              return t;
            },
          },
          {
          ...
          [
            ...
            },
            {
              ...
              value: function (t, e) {
                if (!this._options[t])
                  throw new Error(
                    "".concat(t, " is not a valid option on MeasureTool helper")
                  );
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  (t /= 1852), this._numberToLocale(this._roundUp(t, 2)) + " NM"
                );
              },
            },
            {
          ...
          [
            {
              ...
              value: function (t, e) {
                var n =
                  ((t[1][1] - t[0][1]) * (e[0] - t[0][0]) -
                    (t[1][0] - t[0][0]) * (e[1] - t[0][1])) /
    ...
    oe = function t(n) {
      ...
      if (
        ...
        if ("[object Array]" === Object.prototype.toString.call(n))
          ...
          if (n.nodeType && "function" == typeof n.cloneNode)
            i = n.cloneNode(!0);
          else if (n.prototype) i = n;
          else if (n instanceof Date) i = new Date(n);
          else for (var o in ((i = {}), n)) i[o] = t(n[o]);
        else i = n;
      return i;
    },
    re = function (t) {
      var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
      return e ? "".concat(t, " inverted") : t;
    };
  Xt(
  ...
  var ae = (function () {
    function e(i, o) {
      n(this, e),
        ...
        (this._id = te.makeId(4)),
        (this._events = new Map()),
        (this._geometry = new Wt()),
        this._init();
    }
    return (
      o(
        ...
        [
            ...
            value: function () {
              (this._containerDiv = this._map
                ...
                this._options.tooltip &&
                  (this._tooltip = new Jt(this._containerDiv)),
                (this._helper = new te({ unit: this._options.unit })),
                this._initOverlay();
            },
          },
          {
            ...
            value: function () {
              ...
              this._map.addListener("contextmenu", function (e) {
                (t._firstClick = e),
                  t._contextMenu.show(
                    t._projection.fromLatLngToContainerPixel(e.latLng)
                  );
              }),
                document.addEventListener("keydown", function (e) {
                  ("Escape" !== e.key && 27 !== e.which) ||
                    t._contextMenu.hide();
                }),
            ...
            value: function (t) {
              ...
              if (!this._started) {
                ...
                this._options.contextMenu &&
                  ...
                  (this._mapClickEvent = this._map.addListener(
                    "click",
                    function (t) {
                  ...
                  (this._started = !0),
                  "function" == typeof this._events.get(ee) &&
                    this._events.get(ee)();
              }
            },
          },
          {
            ...
            value: function () {
              this._started &&
                ("function" == typeof this._events.get(ne) &&
                  this._events.get(ne)(this._getResults()),
                this._options.contextMenu &&
                  this._contextMenu.toggleItems(
                    [this._startElementNode],
                    [this._endElementNode]
          ...
          },
          {
            key: "setOption",
            value: function (t, e) {
              if (void 0 === this._options[t])
                throw new Error(
                  "".concat(t, " is not a valid option on MeasureTool")
                );
              (this._options[t] = e),
          ...
          },
          {
            ...
            value: function () {
              this._initComplete || (this._initComplete = !0),
                ...
                (this._projectionUtility = new Kt(
                  this._containerDiv,
                  this._projection
                )),
                (this._svgOverlay = Ct(
                  this._overlay.getPanes().overlayMouseTarget
                )
                  .append("div")
                  .attr(
                    "class",
                    "".concat(zt, "-measure-points-").concat(this._id)
                  )
                  .append("svg")
                  .attr("class", "".concat(zt, "-svg-overlay"))),
                ...
                (this._lineDrag = this._svgOverlay
                  .append("g")
                  .attr("class", "drag")),
                ...
                this._hoverCircle
                  .append("circle")
                  .attr("class", re("grey-circle", this._options.invertColor))
                  .attr("r", 5),
                this._initComplete &&
                  !this._started &&
                  this._overlay.setMap(null);
            ...
            value: function () {
              ...
              this._nodeCircles
                ...
                .attr("class", function (e) {
                  return 0 === a(e, 2)[1]
                    ? "".concat(
                        re("cover-circle", t._options.invertColor),
                        " head-circle"
                      )
                    : re("cover-circle", t._options.invertColor);
                })
                ...
                .enter()
                .append("circle")
                .attr("class", re("cover-circle", this._options.invertColor))
                .attr("r", 5)
                .attr("cx", function (e) {
                  var n = a(e, 1)[0];
                  return t._projectionUtility.latLngToSvgPoint(n)[0];
            ...
            value: function () {
              ...
              this._touchCircles
                ...
                .attr("class", function (e) {
                  return 0 === a(e, 2)[1]
                    ? "".concat(
                        re("touch-circle", t._options.invertColor),
                        " head-circle"
                      )
                    : re("touch-circle", t._options.invertColor);
                })
                ...
                .enter()
                .append("circle")
                .attr("class", re("touch-circle", this._options.invertColor))
                .attr("r", 12)
                .attr("cx", function (e) {
                  var n = a(e, 1)[0];
                  return t._projectionUtility.latLngToSvgPoint(n)[0];
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = this._linesBase
                .selectAll("line")
                .data(this._geometry.lines)
                .attr("class", re("base-line", this._options.invertColor))
                .attr("x1", function (e) {
              ...
              n
                .on("mousemove", function (e, n) {
                  var i = a(n, 1)[0],
                    o = te.findTouchPoint(
                      [
                        t._projectionUtility.latLngToSvgPoint(i[0]),
                        t._projectionUtility.latLngToSvgPoint(i[1]),
                      ],
                      [e.offsetX, e.offsetY]
                    );
            ...
            value: function () {
              var t = this,
                e = this._segmentText
                  ...
                  .attr(
                    "class",
                    re("segment-measure-text", this._options.invertColor)
                  )
                  ...
                  .attr("transform", function (e) {
                    ...
                    return te.transformText(n, i);
                  })
                  .text(function (e, n) {
                    return t._helper.formatLength(
                      t._helper.computeLengthBetween(e[0], e[1])
                    );
                  });
              e
                .enter()
              ...
              var t = this,
                e = this._nodeText
                  ...
                  .attr("class", function (e, n) {
                    return 0 === n
                      ? "".concat(
                          re("node-measure-text", t._options.invertColor),
                          " head-text"
                        )
                      : re("node-measure-text", t._options.invertColor);
                  })
                  ...
                  .text(function (e, n) {
                    var i = t._helper.computePathLength(
                      t._geometry.nodes.slice(0, n + 1)
                    );
                    return (
                      n === t._geometry.nodes.length - 1 && (t._length = i),
                      t._helper.formatLength(i)
                    );
                  });
              e
                .enter()
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (!this._dragging) {
                var o = Ct(n);
                o.classed("base") ||
                  (o = this._nodeCircles.select(
                    "circle:nth-child(".concat(e + 1, ")")
                  )),
                  o.attr("r", 6),
                  this._options.tooltip &&
                    !i &&
                    this._tooltip.show(
                      ...
                      0 === e
                        ? Ht(this._options.language)
                        : qt(this._options.language)
                    );
              }
            },
          },
            ...
            value: function () {
              var t = this,
                ...
                n = Nt().on("drag", function (n, i) {
                  ...
                  (e = !0),
                    (t._dragging = !0),
                    Ct(this).attr("cx", n.x).attr("cy", n.y),
                    t._updateLinePosition.call(t, t._linesBase, o, n),
                    t._updateLinePosition.call(t, t._linesAux, o, n),
                    t._updateNodeCirclePosition(o, n),
                    t._options.showSegmentLength &&
                      t._updateSegmentTextPosition(o, n),
                    t._options.showAccumulativeLength &&
                      t._updateNodeTextPosition(o, n),
                    t._updateArea(
                      o,
                      t._projectionUtility.svgPointToLatLng([n.x, n.y])
                    );
                });
              return (
                n.on("start", function (e) {
                  e.sourceEvent.stopPropagation(),
                    Ct(this).raise().attr("r", 6),
                    t._disableMapScroll();
                }),
                  ...
                  t._enableMapScroll(),
                    e
                      ? (t._geometry.updateNode(
                        ...
                        t._showTooltipOnEvent(
                          0 === s
                            ? Ht(t._options.language)
                            : qt(t._options.language),
                          n
                        ))
                      : s > 0
                      ? (t._geometry.removeNode(s),
                        Ct(this).classed("removed-circle", !0))
                      : (t._geometry.addNode(r), (t._dragged = !0)),
                    (e = !1),
                    (t._dragging = !1),
                    t._overlay.draw();
                }),
              ...
              var t = this,
                ...
                n = Nt().on("drag", function (n, i) {
                  ...
                  if (((t._dragging = !0), !e)) {
                    ...
                    var r = t._lineDrag
                      .selectAll("line")
                      .data(t._geometry.lines);
                    r.exit().remove(),
                      r
                        .enter()
                        .append("line")
                        .attr("class", re("base-line", t._options.invertColor))
                        .attr("x1", function (e) {
                          return t._projectionUtility.latLngToSvgPoint(e[0])[0];
                        })
                        .attr("y1", function (e) {
                      ...
                      t._linesBase.selectAll("line").style("display", "none"),
                      t._linesAux.selectAll("line").style("display", "none"),
                      t._options.showSegmentLength && t._updateSegmentText(),
                      t._options.showAccumulativeLength && t._updateNodeText();
                  }
                  t._updateHoverCirclePosition(n.x, n.y),
                    t._updateLinePosition(t._lineDrag, o + 1, n),
                    t._options.showSegmentLength &&
                      t._updateSegmentTextPosition(o + 1, n),
                    t._options.showAccumulativeLength &&
                      t._updateNodeTextPosition(o + 1, n),
                    t._updateArea(
                      o + 1,
                      t._projectionUtility.svgPointToLatLng([n.x, n.y])
                    );
                ...
                n.on("end", function (n, i) {
                  ...
                  t._enableMapScroll(),
                    e &&
                      ...
                      t._overlay.draw(),
                      (e = !1),
                      t._showTooltipOnEvent(qt(t._options.language), n)),
                    t._updateArea(
                      o + 1,
                      t._projectionUtility.svgPointToLatLng([n.x, n.y])
                    ),
                    t._hoverCircle
                      .select("circle")
                      .attr("class", re("grey-circle", t._options.invertColor)),
                    t._linesBase.selectAll("line").style("display", "inline"),
                    t._linesAux.selectAll("line").style("display", "inline"),
                    (t._dragging = !1);
                }),
                n
              );
          ...
          },
          {
            ...
            value: function (t, e, n) {
              e < this._geometry.lines.length &&
                t
                  .select("line:nth-child(".concat(e + 1, ")"))
                  .attr("x1", n.x)
                  .attr("y1", n.y),
                e > 0 &&
                  t
                    .select("line:nth-child(".concat(e, ")"))
                    .attr("x2", n.x)
                    .attr("y2", n.y);
            },
          },
          {
            ...
            value: function (t, e) {
              ...
              t < this._geometry.lines.length &&
                this._segmentText
                  .select("text:nth-child(".concat(t + 1, ")"))
                  .attr("transform", function (t) {
                    var i = [e.x, e.y],
                      o = n._projectionUtility.latLngToSvgPoint(t[1]);
                    return te.transformText(i, o);
                  })
                  .text(function (t) {
                    return n._helper.formatLength(
                      n._helper.computeLengthBetween(
                        n._projectionUtility.svgPointToLatLng([e.x, e.y]),
                        t[1]
                      )
                    );
                  }),
                t > 0 &&
                  this._segmentText
                    .select("text:nth-child(".concat(t, ")"))
                    .attr("transform", function (t) {
              ...
              this._nodeText
                ...
                .attr("y", function () {
                  ...
                  return (
                    (i =
                      t > 0 &&
                      n._projectionUtility.latLngToSvgPoint(
                        n._geometry.nodes[t - 1]
                      )[1] < e.y
                        ? 23
                        : -7),
                    e.y + i
                ...
                this._nodeText
                  .select("text:nth-child(".concat(t + 2, ")"))
                  .attr("y", function (i) {
                    var o;
                    return (
                      (o =
                        t + 1 > 0 &&
                        e.y < n._projectionUtility.latLngToSvgPoint(i)[1]
                          ? 23
                          : -7),
                      n._projectionUtility.latLngToSvgPoint(i)[1] + o
                    );
                  }),
                this._nodeText
                  .selectAll("text")
                  ...
                  .text(function (i, o) {
                    var r = n._helper.computePathLength(
                      [].concat(
                        s(n._geometry.nodes.slice(0, t)),
                        [n._projectionUtility.svgPointToLatLng([e.x, e.y])],
                        s(n._geometry.nodes.slice(t + 1, t + 1 + o))
                      )
                    );
                    return (
                      t + o === n._geometry.nodes.length - 1 && (n._length = r),
                      n._helper.formatLength(r)
                    );
                  });
            },
          },
          {
            ...
            value: function (t, e) {
              this._nodeCircles
                .select("circle:nth-child(".concat(t + 1, ")"))
                .attr("cx", e.x)
                .attr("cy", e.y);
            },
          },
                ...
                n > 2 &&
                    ...
                    0 === t
                      ? this._helper.computeLengthBetween(
                        ...
                        : this._helper.computeArea(
                            [e].concat(s(this._geometry.nodes.slice(1, n - 1)))
                          )
                      : t === n - 1
                      ? this._helper.computeLengthBetween(
                          e,
                        ...
                        ? 0
                        : this._helper.computeArea(
                            this._geometry.nodes.slice(0, n - 1)
                          )
                      : t > 0 && t < n - 1
                      ? this._helper.computeLengthBetween(
                          this._geometry.nodes[0],
                        ...
                        : this._helper.computeArea(
                            [].concat(
                              s(this._geometry.nodes.slice(0, t)),
                              [e],
                              s(this._geometry.nodes.slice(t + 1))
                            )
                          )
                      : this._helper.computeLengthBetween(
                          this._geometry.nodes[0],
                  ...
                  o > 0 &&
                    this._nodeText
                      ...
                      .text(
                        "Total distance: "
                          .concat(this.lengthText, "; Total area: ")
                          .concat(this.areaText, ".")
                      );
              }
            },
          },
          {
            ...
            value: function (t, e) {
              e.sourceEvent.type.startsWith("touch") ||
                (this._options.tooltip &&
                  this._tooltip.show(
                    this._projectionUtility.svgPointToContainerPoint([
                      e.x,
                      e.y,
                    ]),
                    t
            ...
            value: function () {
              if (this._started) {
                ...
                (this._lastMeasure &&
                  ...
                  ("function" == typeof this._events.get(ie) &&
                    this._events.get(ie)((this._lastMeasure = t)));
              }
            },
          },
          {
            ...
            value: function (t) {
              ...
              this._segments.push(new $t(t[0], t[1], e, n).toJSON());
            },
          },
          {
            key: "_getResults",
